...
import pandas as pd
import glob 
#exec(open("preprocess_data4dds_hap1.py").read())
...
mr_data_folder='../../data/hap1_cell/in_data/final_demo_data/hap1_cell/out_data/DMR_CpG_context/'

#file name of all DMRs in the result folder of dmr_analysis
full_mr_file=os.path.join( mr_data_folder, '3_chroms_all_mr_data_range_dmrRanking.bed')
...
in_genome_folder='../../data/hap1_cell/in_data//final_demo_data/genome'
in_genome_file='hg38/hg38_all_enhancers_merged_hglft_genome_327b3_4dmr.bed'
in_data_str='_hap1'
