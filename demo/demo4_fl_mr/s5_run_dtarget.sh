...
#	on FL data by integrating DMR and DEG data together
#	and predicting the putative target genes of a DMR based on their 
#	associations with either TSS or 5'distance reginos.
