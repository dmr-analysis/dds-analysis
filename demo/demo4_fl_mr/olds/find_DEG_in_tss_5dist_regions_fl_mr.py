...
in_folder='../../data/fl_mr/out_data/out_data_genecode/DMR_CpG_context2/out_map2genome'
in_data_str='_fl_mr'

#file name of TSS regions that overlapping with DMRs that located in in_folder
tss_file='2_chroms_all_mr_data_range_dmrRanking_TSS_Up10000_Down10000_overlap1e-09.bed'
...
dist_file='2_chroms_all_mr_data_range_dmrRanking_noGenes_5dist_Up1000000_Up10000_overlap1e-09.bed'
...
in_deg_file='../../data/fl_mr/in_data/bpb3_demo7_mr_enhancers/out/differentially_expressed_genes.txt'
print('Read DEG file: ')
print(in_deg_file,'\n')
