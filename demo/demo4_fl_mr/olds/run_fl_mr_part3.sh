...
IN_DATA_PATH='../../data/fl_mr/in_data/final_demo_data/fl_12samples/'

#path of DMR results from dmr_analysis
IN_MR_PATH=${IN_DATA_PATH}'/out_data/DMR_CpG_context/'

#path of DEG results from bpb3
IN_DEG_PATH='../../data/fl_mr/in_data/bpb3_demo7_mr_enhancers/out/'

#DEG file name from bpb3 differential_analysis, the original DEF file from bpb3 that was used to convert Zscores in  find_DEG_in_tss_5dist_regions_hap1.py
IN_DEG_FILE='differentially_expressed_genes.txt '
in_data_str='_fl_mr'
...
dds_analysis filterDEG4bpb3 --in_group1_str 'gcb_' --in_group2_str 'DO' \
        --in_folder ${IN_DEG_PATH} \
        --in_file ${IN_DEG_FILE} \
        --min_median_RPKM 0 --rr_cutoff 0.0
echo ""
echo filterDEG4bpb3 - Done
echo ""
echo ""
...
echo  $gene_mr_file
echo  $gene_exp_file
echo  $in_mr_data_folder
echo  $OUT_PATH
echo  $in_background_mr_file
echo ""
...
dds_analysis plot_mr_vs_exp -inGeneEXPfile ${gene_exp_file}  \
	...
	-expTAB -inGene 'BCL2' -inMR 'chr18:mr619' -wtStr 'gcb_' -output_path ${OUT_PATH}
...
dds_analysis plot_tss_enhancer_mrs \
	...
	-is_negative 2 -genes 'BCL2' -mr_folder ${OUT_PATH}/out4dmr_in_deg_tss_5dist/ \
