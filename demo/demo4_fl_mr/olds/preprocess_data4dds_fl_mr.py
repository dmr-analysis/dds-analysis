...
mr_data_folder='../../data/final_demo_data/fl_12samples/out_data/DMR_CpG_context'


#file name of all DMRs in the result folder of dmr_analysis
full_mr_file=os.path.join( mr_data_folder, '2_chroms_all_mr_data_range_dmrRanking.bed')
...
in_genome_folder='../../data/genome/'
in_genome_file='hg19/hg19_all_enhancers_merged_4dmr.bed'
in_data_str='_fl_mr'
